    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#5d74d4;font-weight:bold; font-size:22px; margin-top: 2% !important;">खैरहनी Hospital
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active custom-carousel-item">
                <img class="d-block w-100" src="assets/images/slider/sanduk.1.jpeg" alt="First slide">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown" style="color: blue;">Slide 1</h5>
                </div>
            </div>
            <div class="carousel-item custom-carousel-item">
                <img class="d-block w-100" src="assets/images/slider/slider_3.jpeg" alt="Second slide">
                <div class="carousel-cover"></div>
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown">Slide 2</h5>
                </div>
            </div>
...
<script>
    ...
    $('#myCarousel').on('slide.bs.carousel', function (e) {
        ...
        var nextIndex = (e.direction == 'left') ? currentIndex + 1 : currentIndex - 1;
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <i class="fas fa-hospital" style="color: blue;"></i>
                        <h5>Cardiology</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <i class="fas fa-ribbon"style="color: blue;"></i>
                        <h5>Orthopaedic</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                       <i class="fab fa-monero"style="color: blue;"></i>
                        <h5>Neurologist</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <i class="fas fa-capsules"style="color: blue;"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        <i class="fas fa-prescription-bottle-alt"style="color: blue;"></i>
                        <h5>Pharma Team</h5>
                    </div>
                </div>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/gallery2.webp" class="img-responsive">
            </div>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery5.avif" class="img-responsive">
            </div>
